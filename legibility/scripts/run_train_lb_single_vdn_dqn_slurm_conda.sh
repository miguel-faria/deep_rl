...
if [ "$HOSTNAME" = "artemis" ] || [ "$HOSTNAME" = "poseidon" ] ; then
  ...
  python "$script_path"/run_train_lb_vdn_single_dqn.py --field-len 15 --batch-size 64 --buffer-size 5000 --iterations 5000 --episode-steps 600 --limits 1 8  --logs-dir /mnt/scratch-artemis/miguelfaria/logs/lb-foraging --models-dir /mnt/data-artemis/miguelfaria/deep_rl/models --data-dir /mnt/data-artemis/miguelfaria/deep_rl/data --cycle-type linear --cycle-eps 0.4 --eps-type log --eps-decay 0.07 --use-higher-curriculum --train-thresh 0.9 --version v2
else
