...
class DQNetwork(object):
    ...
    def __init__(self, action_dim: int, num_layers: int, act_function: Callable, layer_sizes: List[int], gamma: float, dueling_dqn: bool = False,
                 ...
                 cnn_properties: List[int] = None, ma_obs: bool = False, n_obs: int = 1):
        ...
        if ma_obs:
            ...
            self._q_network = MultiObsCNNDuelingQNetwork(action_dim=action_dim, num_obs=n_obs, num_layers=num_layers, activation_function=act_function,
